            ...
            tasksByMonth[month].forEach(task => {
                ...
                taskElement.innerHTML = `
                    ...
                    <div class="flex items-center gap-3 ml-4 shrink-0 text-right">
                        ...
                        <button class="reschedule-btn p-2 bg-blue-50 text-blue-500 hover:bg-blue-600 hover:text-white border border-blue-100 rounded-lg shadow-sm transition-all duration-300 group" title="Reprogramar fecha de entrega">
